...
- אם קיימת תקלה טכנית, יש לנסח באופן מקצועי בלבד: "הנושא הועבר לבדיקה / מומלץ להמשיך בדיקה מול תמיכה/פיתוח".
- מבנה חובה:
שלום [שם הלקוח],

תודה על פגישת ההדרכה.

במהלך הפגישה עברנו על [נושאים מרכזיים שעלו בפגישה], תוך התייחסות לצרכי העבודה שעלו ולשאלות שהוצגו במהלך ההדרכה.

בנוסף, הוצגו דגשים והמלצות לעבודה נכונה במערכת, כולל [דגשים רלוונטיים מתוך הפגישה].
...
כפי שסוכם, ניתן להמשיך ולהרחיב בנושאים נוספים במסגרת פגישת המשך ממוקדת.

אשמח להמשך עבודה משותפת,
[שם המטמיע]
`;
